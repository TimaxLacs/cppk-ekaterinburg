...
export const botNodes: BotNode[] = [
  ...
  {
    id: "faq-address-ekb",
    text: "Филиал в Екатеринбурге: ул. 8 Марта, д. 158, офис 207, +7 (343) 257-57-92, ekb@cppkspb.ru. Автодром передали отдельно: Верхняя Пышма, ул. Петрова, д. 59а, +7 (343) 328-29-30. На сайте филиала автодром указан только как «г. Екатеринбург». Режим кабинета: пн-чт 9:00-18:00, пт 9:00-17:00, обед 13:00-13:48.",
    source: "Кабинет, телефон, почта и часы: cppkspb.ru/about. Улица и телефон площадки переданы отдельно, на about их нет.",
    site: {
